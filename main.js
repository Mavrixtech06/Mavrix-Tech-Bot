...
const vcfCommand = require('./commands/vcf'); // VCF Command for exporting contacts
    ...
    try {
        ...
        switch (true) {
            ...
            case userMessage.startsWith('.demote'):
                ...
                break;
            // VCF Command - Export group contacts
            case userMessage === '.vcf' || 
                 userMessage === '.contacts' || 
                 userMessage === '.savecontacts' || 
                 userMessage === '.getcontacts' || 
                 userMessage === '.exportcontacts':
